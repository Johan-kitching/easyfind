...
class SmallFonts extends Tailwind
{
    ...
    public function table(): Table
    {
        return Theme::table('min-w-full dark:bg-slate-800')
            ...
            ->th('font-semibold px-2 pr-4 py-3 text-left text-xs font-semibold text-pg-primary-700 tracking-wider whitespace-nowrap max-w-[200px] dark:text-pg-primary-300')
            ...
            ->tdBody('pl-[19px] px-3 py-2 max-w-[200px] dark:text-pg-primary-200 text-xs')
