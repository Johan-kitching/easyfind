<div
    ...
    id="newTransporter"
    tabindex="-1"
    aria-labelledby="newTransporter">
    <div
        ...
        <div
            ...
            <x-modal-header>Updating: {{$transporter->id}} - {{$transporter->type->name}}</x-modal-header>
...
{{--                                    {{$address_longitude}}--}}
                                    <div>
                                        <div id="mapField">
                                            ...
                                            <x-input icon="map-pin" id="autocomplete" class="block mt-1 w-full" type="text" name="address-add" autocomplete="street-address" label="{{ __('Physical Address') }}" value="{{$address}}"/>
                                        </div>
