<div
    ...
    <div
        ...
        <div
            ...
            <x-modal-header>Availability: {{$machinery->type->category}} - {{$machinery->type->type}} - {{$machinery->type->model}}</x-modal-header>
            <div class="relative flex-auto p-4" data-te-modal-body-ref>
                <div class="flex flex-nowrap gap-4">
                    {{--                    Content--}}
                    <div class="my-2 w-full text-center" x-transition>
                        @include("machinery.components.availability-form")
                    </div>
                </div>
                <div
