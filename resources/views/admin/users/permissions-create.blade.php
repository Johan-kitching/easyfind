...
<div
    ...
    <div
        ...
        <div
            ...
            <x-modal-header>New Permission Group</x-modal-header>
                    ...
                    <div class="my-2 w-full text-center" x-transition>
                        <div class="text-left w-full flex justify-center">
                            <form id="locationForm" class="w-full max-w-5xl">
                                ...
                                @else
                                    <x-input id="name" name="name" wire:model="name" placeholder="Name" required label="Name" readonly/>
                                @endif
                                <p class="h-2"></p>
                                <div
                                ...
                                <div class="grid grid-cols-3 gap-4 w-full">
                                    ...
                                    <x-toggle label="{{ucfirst(str_replace('_', ' ',$permission['name']))}}" wire:model="currentPermission.{{$permission['id']}}"></x-toggle>
                                    @endforeach
                                </div>
                            </form>
                        </div>
